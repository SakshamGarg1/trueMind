    ...
    return(
        ...
        <header>
            <h1 className='myfont ms-2'>
                TURE MIND 
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" className="bi bi-graph-up-arrow" viewBox="0 0 16 16">
         ...
         <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" className="bi bi-cart2" viewBox="0 0 16 16" >
           ...
           <form className='cartitem'>
                <p className='closebtn'>
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16" onClick={()=>removeItem(i)}>
